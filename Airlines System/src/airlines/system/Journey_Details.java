...
public class Journey_Details extends JFrame {
	...
	String[] items1 =  {"BHUBANESHWAR", "SURAT", "CHENNAI", "VARANASI","DELHI","HYDERABAD"};
	JComboBox comboBox = new JComboBox(items1);
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
		
		
	String[] items2 =  {"KOLKOTA", "HYDERABAD", "RAJKOT","DELHI","SURAT","INDORE","COIMBATORE"};
	...
	Show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    String str = "select pnr_no,ticket_id,fcode,journey_date,journey_time,src,dst from reservation where src = '"+src+"' and dst = '"+dst+"'";
