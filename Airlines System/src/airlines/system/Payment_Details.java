...
public class Payment_Details extends JFrame{
	...
	add(Classname);
        ...
        label = new JLabel("");
	label.setIcon(new ImageIcon(ClassLoader.getSystemResource("airlines/system/icons/payment.png")));
	...
	Show.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                ...
                try {
                    ...
                    Conn c = new Conn();
                    String str = "select pnr_no,ph_no,cheque_no,card_no,paid_amt,pay_date from payment where pnr_no = '"+code+"'";
