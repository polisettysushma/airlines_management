...
public class Mainframe extends JFrame {
    ...
    private void initialize() {
        ...
        NewLabel.setIcon(new ImageIcon(ClassLoader.getSystemResource("airlines/system/icons/flight.jpg")));
	...
	AirlineSystem.add(ReservationDetails);
        ...
        JMenuItem BookingDetails = new JMenuItem("TICKET_BOOKING");
	AirlineSystem.add(BookingDetails);
